...
export default function Home() {
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mt-8 px-4 md:px-5">
        {allProducts?.map((product) => {
          ...
          return (
            <div
              key={product._id}
              className="bg-gray-50 rounded-xl relative overflow-hidden group p-5 flex flex-col shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100"
            >
